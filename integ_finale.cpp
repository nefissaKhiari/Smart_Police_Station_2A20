    ...
    ui(new Ui::integ_finale)
{
    ...
    trier1=new Personne();
    ui->table_personne6->setModel(trier1->afficher());
        QHeaderView *header=ui->table_personne6->horizontalHeader() ;
...
void integ_finale::on_pb_ajouter_clicked()
{
    int idEquipement=ui->le_id->text().toInt();
        ...
        Equipement E(idEquipement,quantiteEquipement,etatEquipement,nomEquipement,typeEquipement,DateFab);
...
void integ_finale::on_pb_ajouter_3_clicked()
{
   click->play() ;
     ...
     smtp.setPassword("538886282A1");
      ...
      message.addRecipient(new EmailAddress("nourelhouda.zraibia@esprit.tn", "ahmed"));
...
void integ_finale::update_label()
{
   ...
   if(data=="4")
           ui->label_distance->setText("distance est inférieur a 10");

    else  if(data=="5")
           ui->label_distance->setText("distance safe");
...
void integ_finale::on_pushButton_38_clicked()
{
...
void integ_finale::on_ajouter_petition_clicked()
{
    ...
    QString date_petition=ui->dateEdit_2->text();
...
void integ_finale::on_pushButton_48_clicked()
{
...
void integ_finale::on_gotopersonnes_clicked()
{
    ui->stackedWidget->setCurrentIndex(6) ;
...
void integ_finale::on_pushButton_3_clicked()
{
...
void integ_finale::on_ajouter_p6_clicked()
{
...
void integ_finale::on_supprimer_p6_clicked()
{
...
void integ_finale::on_modifier_p6_clicked()
{
...
void integ_finale::on_search_button6_clicked()
{
...
void integ_finale::on_refresh6_clicked()
{
    p = new Personne();
   QSqlQueryModel *model = p->afficher();
...
void integ_finale::on_espace_chercher6_textChanged()
{
    Personne b;
...
void integ_finale::on_annulerA6_clicked()
{
    ui->stackedWidget6->setCurrentIndex(0);
    on_refresh6_clicked() ;
}

void integ_finale::on_annuler_M6_clicked()
{
    ui->stackedWidget6->setCurrentIndex(0);
    on_refresh6_clicked() ;
}

void integ_finale::on_annuler_S6_clicked()
{
 ui->stackedWidget6->setCurrentIndex(0);
 on_refresh6_clicked() ;
}

void integ_finale::on_confirmer_A_R6_clicked()
{
...
void integ_finale::on_confirmerM_R6_clicked()
{
    QRegExp re("\\d*");
    int id=0 ;
    int control=1;
...
void integ_finale::on_confimerS_R6_clicked()
{
...
void integ_finale::on_ajouter_S6_clicked()
{
  ui->stackedWidget_26->setCurrentIndex(1);
}

void integ_finale::on_modifier_S6_clicked()
{
  ui->stackedWidget_26->setCurrentIndex(3);
}

void integ_finale::on_supprimer_S6_clicked()
{
    ui->stackedWidget_26->setCurrentIndex(2);
}

void integ_finale::on_annulerAS6_clicked()
{
...
void integ_finale::on_annuler_SS6_clicked()
{
    ui->stackedWidget_26->setCurrentIndex(0);
   // ui->tableView_2->setModel(tmpp.afficher());
    on_refresh6_clicked() ;
...
void integ_finale::on_annnulerMS6_clicked()
{
    ui->stackedWidget_26->setCurrentIndex(0);
   // ui->tableView_2->setModel(tmpp.afficher());
    on_refresh6_clicked() ;
...
void integ_finale::on_confirmerSS6_clicked()
{
...
void integ_finale::on_confirmerMS66_clicked()
{
...
void integ_finale::on_confirmerAS6_clicked()
{
...
void integ_finale:: modifierr(int index)
{
...
int integ_finale :: getIDFromTableView6(QTableView * tv){
    int id =-1;
 ...
 void integ_finale::on_table_personne6_clicked()
{
...
void integ_finale::on_pushButton_166_clicked()
{
...
void integ_finale::on_pushButton6_clicked()
{
    hide();
    integ_finale integ;
    integ.setModal(true);
...
void integ_finale::on_confimerS_R_clicked()
{
    int id = ui->lineEdit_S->text().toInt();
    bool test=tmppers.supprimer(id);
    if(test)
...
void integ_finale::on_annuler_S_clicked()
{
    ui->stackedWidget6->setCurrentIndex(0);
    on_refresh6_clicked() ;
}

...
bool Maintenance::ajouterMaintenance()
{
      ...
      query.prepare("INSERT INTO maintenance (idMaintenance, dureeMaintenance, dateEntreeM,dateSortieM,frais,fk_equipement) "
                       "VALUES (:idM, :dureeMaintenance, :dateEntreeM,:dateSortieM,:frais,:fk_equipement)");
      // query.prepare("insert into maintenance (idMaintenance='"+idM+"', dureeMaintenance='"+dureeMaintenance+"',dateEntreeM='"+dateEntreeM+"',dateSortieM='"+dateSortieM+"',frais='"+qM+"',fk_equipement='"+fk_eq+"' where idMaintenance=:idMaintenance");

...
agent::agent(QString cin_agent,QString nom_agent,QString prenom_agent,QString sexe_agent,QString date_de_naissance_agent,QString adresse_agent,QString telephone_agent,QString nationalite_agent,QString etat_civil_agent,QString email_agent)
...
{
    QSqlQuery query;
    query.prepare("INSERT INTO agent (cin_agent, nom_agent,prenom_agent,sexe_agent,date_de_naissance_agent,adresse_agent, telephone_agent, nationalite_agent, etat_civil_agent, email_agent ) ""VALUES (:cin_agent,:nom_agent,:prenom_agent,:sexe_agent,:date_de_naissance_agent,:adresse_agent,:telephone_agent,:nationalite_agent,:etat_civil_agent,:email_agent)");
...
bool agent::modifier_agent(QString cin_agent,QString nom_agent,QString prenom_agent,QString sexe_agent,QString date_de_naissance_agent,QString adresse_agent,QString telephone_agent,QString nationalite_agent,QString etat_civil_agent,QString email_agent)
{  QSqlQuery query;



    query.prepare("update agent set cin_agent='"+cin_agent+"', nom_agent='"+nom_agent+"',prenom_agent='"+prenom_agent+"',sexe_agent='"+sexe_agent+"',date_de_naissance_agent='"+date_de_naissance_agent+"',adresse_agent='"+adresse_agent+"',telephone='"+telephone_agent+"',nationalite_agent='"+nationalite_agent+"',etat_civil_agent='"+etat_civil_agent+"',email_agent='"+email_agent+"' where cin_agent=:cin_agent");

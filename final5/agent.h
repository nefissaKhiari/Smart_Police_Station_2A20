...
private:
        QString cin_agent,nom_agent,prenom_agent,sexe_agent,date_de_naissance_agent,adresse_agent,telephone_agent,
        nationalite_agent,service_agent,email_agent;
        QByteArray image;

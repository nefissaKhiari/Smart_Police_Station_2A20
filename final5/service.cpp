...
{
    QSqlQuery query;
    query.prepare("INSERT INTO service (id_service, titre_service,auteur_service,date_service,description_service,validite_service) "
                  "VALUES (:id_service,:titre_service,:auteur_service,:date_service,:description_service,:validite_service)");
...
bool service::modifier_service(QString id_service,QString titre_service,QString auteur_service,QString date_service,
                                 QString description_service,QString validite_service,QString nbr_signatures_requis)
{  QSqlQuery query;
...
bool service::modifier2(QString id_service,QString titre_service,QString auteur_service,QString date_service,
                        QString description_service,QString validite_service,QString nbr_signatures_requis)
{QSqlQuery edit;
    edit.prepare("Update service set id_service=:id_service,auteur_service=:auteur_service,date_service=:date_service,description_service=:description_service,validite_service=:validite_service where id_service=:id_service");
    edit.bindValue(":id_service",id_service);
    edit.bindValue(":titre_service",titre_service);
    edit.bindValue(":auteur_service",auteur_service);
    edit.bindValue(":date_service",date_service);
    edit.bindValue(":description_service",description_service);
    edit.bindValue(":validite_service",validite_service);
    return       edit.exec()  ;
}

...
void MainWindow::on_ajouter_agent_clicked()
{
    ...
    agent c(cin_agent, nom_agent, prenom_agent,sexe_agent,date_naissance_agent,adresse_agent, telephone_agent,nationalite_agent, etat_civil_agent,email_agent);
...
void MainWindow::on_modifier_agent_clicked()
{
    ...
    agent C(cin_agent, nom_agent, prenom_agent,sexe_agent,date_naissance_agent,adresse, tel,nationalite_agent, etat_civil,email);
    bool test=C.modifier_agent(C.getcin_agent(),C.getnom_agent(),C.getprenom_agent(),C.getsexe_agent(),C.getdate_naissance_agent(),C.getadresse_agent(),C.gettelephone_agent(),C.getnationalite_agent(),C.getetat_civil_agent(),C.getemail_agent());
    QMessageBox msgBox;

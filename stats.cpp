...
int stats::Statistique_partie2()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from detenu where sexe='none'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int stats::Statistique_partie3()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from detenu where sexe='homme'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int stats::Statistique_partie4()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from detenu where sexe='femme'") ;
    while(requete.next())
    {
            count++ ;
    }
...
/*int stats::Statistique_partie2()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from from detenu where sexe=''") ;
    while(requete.next())
    {
            count++ ;
    }

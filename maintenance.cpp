...
bool Maintenance::ajouterMaintenance()
{
   QSqlQuery query;
    ...
    query.bindValue("idMaintenance", idMaintenance_string);
    query.bindValue("dureeMaintenance", dureeMaintenance);
    query.bindValue("dateEntreeM", dateEntreeM);
    query.bindValue("dateSortieM",dateSortieM );
    query.bindValue("frais", frais_string);
    query.bindValue("fk", fk_equipement_string);

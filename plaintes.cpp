...
Plaintes::Plaintes(int idp,QString raisonp,QString datep,QString typep,int idpersonnee)
{
    id=idp;
    raison=raisonp;
    date=datep;
    type=typep;
    idpersonne=idpersonnee ;
...
query.prepare("INSERT INTO PLAINTE (IDP,RAISON,DATEP,TYPE,IDPERSONNE) "
                    "VALUES (:id, :raison, :date, :type,:idpersonne )");
...
QSqlQueryModel * Plaintes::afficher(int id)
{

    QSqlQueryModel * model = new QSqlQueryModel();
    QSqlQuery query;
    query.prepare(QString("Select * from PLAINTE WHERE IDPERSONNE=:id"));

...
public:
    agent();
     agent(QString,QString,QString,QString,QString,QString,QString,QString,QString,QString,QString);
    ...
    QSqlQueryModel * rechercher_nom_agent(QString);
     ...
     bool modifier_agent(QString,QString,QString,QString,QString,QString,QString,QString,QString,QString,QString);
    void  AjoutImage(QString );
private slots:

private:
        QString cin_agent,nom_agent,prenom_agent,sexe_agent,date_de_naissance_agent,adresse_agent,telephone_agent,nationalite_agent,etat_civil_agent,email_agent,image;
